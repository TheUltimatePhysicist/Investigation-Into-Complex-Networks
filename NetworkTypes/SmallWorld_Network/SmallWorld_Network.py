...
# Create an adjacency matrix which corresponds to a small world network.

def GenerateAdjacencyMatrix(numberOfNodes, averageDegree, probability):
    ...
    # Defining temporary method variables

    edgeDensity = averageDegree / (numberOfNodes - 1)
